...
#sh startup.sh -m standalone 1 >/dev/null
set -x
export CUSTOM_SEARCH_NAMES="application"
export CUSTOM_SEARCH_LOCATIONS=file:/opt/nacos-server/nacos/conf/
export MEMBER_LIST=""
PLUGINS_DIR="/opt/nacos-server/nacos/plugins/peer-finder"
